...
const SearchInput = () => {
  ...
  return (
    <div className="search-input-container   left-[-5px] relative " onClick={handleClick}>
      <svg className="absolute left-6 " xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="23" fill="#5f3dc4" height="23" viewBox="0 0 50 50">
      ...
      <input
        ...
        type="text"
        className="search-input font-semibold   text-center rounded-lg   h-[50px]  placeholder:text-[#5f3dc4]"
        placeholder="Start Your Property Search  "
        readOnly // Prevents typing, making it clear that it's a clickable field
      />
      <svg className="absolute right-8" xmlns="http://www.w3.org/2000/svg" width="28" height="50" viewBox="0 0 100 50" fill="#5f3dc4" >
